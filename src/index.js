...
const renderIndexPage = (toiletObj) => {
    ...
    toiletObj.forEach(toilet => {
        ...
        const borough = createNode("p", toilet.borough)
        const neighborhood = createNode("p", toilet.neighborhood)
        const address = createNode("p", toilet.address)
        const location = createNode("p", toilet.location)
